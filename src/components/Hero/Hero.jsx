...
const headphoneData = [
  {
    ...
    subtitle:
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minima est explicabo, error exercitationem eligendi doloremque nulla earum esse.",
    price: "$100",
    modal: "Modal Brown",
    bgColor: "#8b5958",
  },
    ...
    <>
      <section className="bg-brandDark text-white font-varela">
        <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[700px]">
          {/* Headphone info */}
          <div className="flex flex-col justify-center py-14 md:grid-cols-2 md:py-0 xl:max-w-[500px]">
